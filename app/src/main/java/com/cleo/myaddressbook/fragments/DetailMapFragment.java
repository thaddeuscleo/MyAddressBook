    ...
    private OnMapReadyCallback callback = new OnMapReadyCallback() {
        ...
        public void onMapReady(GoogleMap googleMap) {
            ...
            if (getArguments() != null) {
                ...
                latitude = Double.parseDouble(employee.getLocation().getCoordinate().getLatitude());
                longitude = Double.parseDouble(employee.getLocation().getCoordinate().getLongitude());
            }

            LatLng position = new LatLng(latitude, longitude);

            if (employee != null) {
                googleMap.addMarker(new MarkerOptions().position(position).title("Marker in " + employee.getLocation().getCity()));
            }
